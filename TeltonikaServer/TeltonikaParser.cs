...
namespace TeltonikaServer
{
    ...
    /// TeltonikaFMXXXX
    /// </summary>
    public class ProtocolTeltonikaFmxxxx
    {
        ...
        public static List<Position> ParseData(Byte[] byteBuffer, int size, out  int index)
        {

            List<Position> result = new List<Position>();
            result = ParsePositions(byteBuffer, size, out index);
